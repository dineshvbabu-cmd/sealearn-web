...
export const SITE_DEFAULTS: Record<string, Record<string, string>> = {
  ...
  about: {
    ...
    mission_heading: "Shaping the Future of Nigerian Seafarers",
    mission_image_url: "https://images.unsplash.com/photo-1578574577315-3fbeb0cecdc2?w=900&q=80",
    highlight_1: "Lagos campus at Apapa Port Road — Africa's busiest port",
    highlight_2: "3,200+ graduates serving on vessels worldwide",
    highlight_3: "Class A bridge and engine room simulators",
    highlight_4: "NIMASA-registered digital certificates with QR verification",
    stat1_value: "2,400+",
    ...
    value1_icon: "⚓", value1_title: "Safety First",  value1_body: "Safety is non-negotiable — in training, at sea, and on campus.",
    value2_icon: "🎯", value2_title: "Integrity",     value2_body: "Transparent operations, honest assessments, accountable leadership.",
    value3_icon: "🏆", value3_title: "Excellence",    value3_body: "98% pass rate and industry-leading placement backed by expert faculty.",
    value4_icon: "📋", value4_title: "Compliance",    value4_body: "Fully aligned with NIMASA, IMO, STCW 2010 Manila and MLC 2006.",
    value5_icon: "💡", value5_title: "Innovation",    value5_body: "AI-powered student support, Class A simulators and digital LMS.",
    value6_icon: "🤝", value6_title: "Community",     value6_body: "A strong alumni network of 3,200+ seafarers serving globally.",
  },
  admissions: {
    ...
    step1_body: "Complete the online application form and upload your documents. No application fee required.",
